 ...
 * availability. Client mirror of functions/src/shared/schema-mapping.ts.
 */
import { ArticleInput, JsonLd, PersonInput, SCHEMA_CONTEXT, buildArticle, buildPerson, toIsoDate } from './structured-data';
import { ARTICLE_FAMILY, ContentTypeSchema, schemaTypeMeta } from '../constants/schema-types';
import type { HowToBlock } from './content-blocks';
