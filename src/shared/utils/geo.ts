/**
 * Map location handling for the Map Location field.
 *
 ...
 *
 * Mirrored server-side in functions/src/shared/geo.ts — a parity spec checks
 * the two agree, so this file is the one to change.
 */
