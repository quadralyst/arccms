/**
 * Image size variants (server copy).
 *
 ...
 *
 * Mirror of src/shared/utils/image-sizes.ts, which is the source of truth —
 * the Cloud Functions build cannot import from src/. A parity spec keeps
 * them agreeing.
 */
