/**
 * Colour handling for the Color custom field (server copy).
 *
 ...
 *
 * Mirror of src/shared/utils/color.ts, which is the source of truth — the Cloud
 * Functions build cannot import from src/. A parity spec keeps them
