...
export function buildTestEmailHtml(textContent: string): string {
    return `
...
export async function testSmtpWithEmail(config: EmailSettings, testEmail?: string, subject?: string, message?: string) {
...
export async function testGmailWithEmail(config: EmailSettings, testEmail?: string, subject?: string, message?: string) {
    const gmail = config.gmail;
    if (!gmail) {
        throw new Error('Gmail settings are required');
    }
...
export async function testResendWithEmail(config: EmailSettings, testEmail?: string, subject?: string, message?: string) {
